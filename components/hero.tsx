    ...
    return (
      <section>
        <div className="mx-auto px-4 mb-24">
          <div className="grid h-full items-center gap-1 grid-cols-2">

          <div
              className="col-span-1 flex h-full flex-col items-center justify-center py-10 sm:col-span-2 md:col-span-1"
            >
            ...
            <div
              className="col-span-1 flex h-full flex-col items-center justify-center py-10 sm:col-span-2 md:col-span-1"
            >
              <img src="/assets/stephen-weber.png" />
            </div>
